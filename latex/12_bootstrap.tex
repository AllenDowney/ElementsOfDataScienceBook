...
\midrule
0 & 2021000001 & 150 & 32.66 & 2 & 11 & 2.14 & 3 & 744.746 & 140 & 72 \\
1 & 2021000002 & 168 & NaN & 2 & 10 & 1.28 & NaN & 299.137 & 160 & 67 \\
2 & 2021000003 & 165 & 77.11 & 2 & 11 & 0.71 & 2 & 587.863 & 160 & 72 \\
3 & 2021000004 & 163 & 88.45 & 2 & 9 & 1.65 & 5 & 1099.62 & 160 & 62 \\
4 & 2021000005 & 180 & 93.44 & 1 & 12 & 2.58 & 2 & 1711.83 & 170 & 77 \\
\midrule
\end{tabular}
...
\begin{center}
\includegraphics[scale=0.6666666]{12_bootstrap_files/12_bootstrap_121_0.png}
\end{center}
...
\begin{lstlisting}[style=output]
   <td>grass</td>      <th>  No. Observations:  </th>  <td> 38669</td> 
\end{lstlisting}

Model:

\begin{lstlisting}[style=output]
           <td>Logit</td>      <th>  Df Residuals:      </th>  <td> 38666</td> 
\end{lstlisting}

Method:

\begin{lstlisting}[style=output]
           <td>MLE</td>       <th>  Df Model:          </th>  <td>     2</td> 
\end{lstlisting}

Date:

\begin{lstlisting}[style=output]
      <td>Wed, 15 May 2024</td> <th>  Pseudo R-squ.:     </th>  <td>0.07506</td>
\end{lstlisting}

Time:

\begin{lstlisting}[style=output]
          <td>17:02:11</td>     <th>  Log-Likelihood:    </th> <td> -22624.</td>
\end{lstlisting}

converged:

\begin{lstlisting}[style=output]
       <td>True</td>       <th>  LL-Null:           </th> <td> -24460.</td>
\end{lstlisting}
...
\begin{lstlisting}[style=output]
<td>    0.0205</td> <td>    0.001</td> <td>   17.203</td> <td> 0.000</td> <td>    0.018</td> <td>    0.023</td>
\end{lstlisting}
...
\begin{center}
\includegraphics[scale=0.6666666]{12_bootstrap_files/12_bootstrap_151_0.png}
\end{center}
