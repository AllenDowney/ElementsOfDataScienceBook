...
\index{read\_fwf (Pandas function)}
...
the column names:
\index{columns (DataFrame attribute)}
...
babies last.
\index{value\_counts (Series method)}
\index{sort\_index (Series method)}
...
\begin{center}
\includegraphics[scale=0.6666666]{07_dataframes_files/07_dataframes_61_0.png}
\end{center}
...
\index{missing data}
\index{isna (Series method)}
\index{notna (Series method)}
...
\index{to\_hdf (DataFrame method)}
\index{file}
\index{HDF file}
