...
\index{ProPublica}
\index{predictive algorithm}
\index{criminal justice}
\index{COMPAS}
...
\includegraphics[scale=0.333333]{figs/machine_bias_table.png}
...
\index{cross\_tab (Pandas function)}
...
\index{negative predictive value}
