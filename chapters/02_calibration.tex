...
\includegraphics[width=4in]{chapters/figs/calibration1.png}
...
\begin{center}
\includegraphics[width=4in]{chapters/02_calibration_files/02_calibration_20_0.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=4in]{chapters/02_calibration_files/02_calibration_36_0.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=4in]{chapters/02_calibration_files/02_calibration_38_0.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=4in]{chapters/02_calibration_files/02_calibration_63_0.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=4in]{chapters/02_calibration_files/02_calibration_65_0.pdf}
\end{center}
