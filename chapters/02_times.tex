...
\begin{lstlisting}[style=output]
Timestamp('2024-04-22 10:31:47.810471')
\end{lstlisting}
...
\begin{lstlisting}[style=output]
Timedelta('20801 days 10:31:47.810471')
\end{lstlisting}
...
\begin{lstlisting}[style=output]
Components(days=20801, hours=10, minutes=31, seconds=47,
    milliseconds=810, microseconds=471, nanoseconds=0)
\end{lstlisting}
