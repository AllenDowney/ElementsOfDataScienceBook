...
now
(@\dashfill@)
@@@Timestamp('2023-03-05 11:30:12.258924')@@@
\end{lstlisting}
...
age
(@\dashfill@)
@@@Timedelta('12327 days 11:30:12.258924')@@@
\end{lstlisting}
...
age.components
(@\dashfill@)
@@@Components(days=12327, hours=11, minutes=30, seconds=12, milliseconds=258, microseconds=924, nanoseconds=0)@@@
\end{lstlisting}
