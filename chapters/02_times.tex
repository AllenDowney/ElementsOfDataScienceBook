...
\begin{lstlisting}[style=output]
Timestamp('2024-03-12 09:47:46.265617')
\end{lstlisting}
...
\begin{lstlisting}[style=output]
Timedelta('12700 days 09:47:46.265617')
\end{lstlisting}
...
\begin{lstlisting}[style=output]
Components(days=12700, hours=9, minutes=47, seconds=46, milliseconds=265, microseconds=617, nanoseconds=0)
\end{lstlisting}
