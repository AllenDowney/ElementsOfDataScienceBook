...
The most common way to represent location, at
...
Now we can use \passthrough{\lstinline!haversine!} as part of a new function called \passthrough{\lstinline!haversine_distance!} to compute haversine distances. I won't explain this function in as
...
\item [2.1]
\label{exercise-1}
When personal names are stored in a database, they
...
\item [2.2]
\label{exercise-2}
Use the value of \passthrough{\lstinline!now!} to
display the name of the current month and day of the week.

\item [2.3]
\label{exercise-3}
Any two people with different birthdays have a
...
\item [2.4]
\label{exercise-4}
Find the latitude and longitude of the place you were
born or someplace you think of as your home town. You can use the web page \emph{https://www.latlong.net/} to look it up. Make a tuple of floating-point numbers to represent that
location.

\item [2.5]
\label{exercise-5}
Use \passthrough{\lstinline!haversine\_distance!} to
...
\item [2.6]
\label{exercise-6}
Modify the code in this section to plot a point that
