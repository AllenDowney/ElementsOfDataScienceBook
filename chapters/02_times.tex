...
now
(@\dashfill@)
@@@Timestamp('2022-01-17 19:35:37.659563')@@@
\end{lstlisting}
...
age
(@\dashfill@)
@@@Timedelta('11915 days 19:35:37.659563')@@@
\end{lstlisting}
...
age.components
(@\dashfill@)
@@@Components(days=11915, hours=19, minutes=35, seconds=37, milliseconds=659, microseconds=563, nanoseconds=0)@@@
\end{lstlisting}
