...
\begin{lstlisting}[style=output]
Timestamp('2024-04-22 10:25:33.119893')
\end{lstlisting}
...
\begin{lstlisting}[style=output]
Timedelta('20801 days 10:25:33.119893')
\end{lstlisting}
...
\begin{lstlisting}[style=output]
Components(days=20801, hours=10, minutes=25, seconds=33,
    milliseconds=119, microseconds=893, nanoseconds=0)
\end{lstlisting}
