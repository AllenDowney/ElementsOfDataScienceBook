...
\begin{center}
\includegraphics[width=4in]{chapters/10_regression_files/10_regression_31_0.png}
\end{center}
...
\begin{center}
\includegraphics[width=4in]{chapters/10_regression_files/10_regression_48_0.png}
\end{center}
...
\begin{center}
\includegraphics[width=4in]{chapters/10_regression_files/10_regression_51_0.png}
\end{center}
...
\begin{center}
\includegraphics[width=4in]{chapters/10_regression_files/10_regression_77_0.png}
\end{center}
