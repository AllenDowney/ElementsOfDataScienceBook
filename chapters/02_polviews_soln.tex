...
Cell In[11], line 3
      1 pmf74.bar(label="1974", color="C0", alpha=0.7)
----> 3 decorate(
      4     xlabel="Political view on a 7-point scale",
      5     ylabel="Fraction of respondents",
      6     title="Distribution of political views",
      7 )
