...
Data science uses  data to answer questions and guide decision
...
In this chapter we will discuss fundamentals of structuring a data science project and explore variables, values, and translating formulas from math notations in Python. Along the way, we'll review a couple of math topics I assume you have
seen before, logarithms and algebra. 

\section{A Data Science Projects Primer}\label{data-science-projects-primer}
...
\section{Programming in Python}\label{programming-in-python}}
...
when I use a programming feature, I try to explain it clearly. Also, I encourage you to do the exercises as you go along.
...
example of an \passthrough{\lstinline!int!} followed by an example of a
...
The operator that performs multiplication is
\passthrough{\lstinline!*!}: 
...
@@@6@@@
\end{lstlisting}
The operater that performs division is \passthrough{\lstinline!/!}:
\begin{lstlisting}[]
2 / 3
(@\dashfill@)
@@@0.6666666666666666@@@
...
\emph{import} it. Here's how we import NumPy:
...
We'll see other examples of floating-point approximation later, and we'll 
...
operation, it represents the value \passthrough{\lstinline!5!}. Here are two examples of how that works:
...
\subsection{Calculating with Variables}\label{calculating-with-variables}}
